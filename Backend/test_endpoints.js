...
const testEndpoints = async () => {
  ...
  try {
    ...
    if (analysisData.data) {
      ...
      console.log('   Matched Skills:', analysisData.data.matchedSkills?.length || 0);
      console.log('   Missing Skills:', analysisData.data.missingSkills?.length || 0);
    }
    console.log('');
...
console.log('⚠️  Note: Update the token and jobId variables in this file first!\n');
// testEndpoints();
