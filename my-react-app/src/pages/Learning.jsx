      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex gap-4 mb-8">
          <button
            ...
            className={`px-8 py-4 rounded-xl font-bold text-lg transition-all shadow-md ${activeTab === 'courses'
          ...
          <button
            ...
            className={`px-8 py-4 rounded-xl font-bold text-lg transition-all shadow-md ${activeTab === 'projects'
                ? 'bg-blue-600 text-white hover:bg-blue-700'
                : 'bg-white text-gray-800 hover:bg-gray-100 border border-gray-200'
              }`}
          >
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <span className={`px-4 py-2 rounded-full font-bold text-sm ${course.level === 'Beginner' ? 'bg-green-100 text-green-700' :
            ...
            {projects.map((project) => (
              <div key={project.id} className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all p-6">
                ...
                <div className="flex gap-4 mb-4 text-sm">
                  <span className={`px-3 py-1 rounded-full font-semibold ${project.difficulty === 'Beginner' ? 'bg-green-100 text-green-700' :
                      project.difficulty === 'Intermediate' ? 'bg-blue-100 text-blue-700' :
                        'bg-purple-100 text-purple-700'
                    }`}>
                    {project.difficulty}
                  </span>
                  <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full font-semibold flex items-center gap-1">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    {project.duration}
                  </span>
                </div>
