...
const FeatureSection = () => {
  return (
    <section
      id="features"
      className="relative py-24 px-4 bg-gradient-to-br from-white via-blue-50 to-purple-50"
    >
      <div className="max-w-7xl mx-auto">
        {/* Feature 1: Find your passion */}
        <div
          className="grid lg:grid-cols-2 gap-16 items-center mb-32 reveal"
          data-delay="1"
        >
          <div>
            <img
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-6">
              We help you find not just a job, but a career that you'll love.
              Our advanced AI analyzes your skills, interests, and career goals
              to match you with opportunities that align with your passion.
            </p>
