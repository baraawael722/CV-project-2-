    ...
    <div className="bg-white rounded-2xl shadow-md p-6 border border-gray-100 mb-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">Showing JobStatistic Jul 19-25</p>
        </div>
        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex gap-6 mt-4 ml-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-700 text-sm font-medium">Job View</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 bg-blue-500 rounded-sm"></div>
              <span className="text-gray-700 text-sm font-medium">Job Applied</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm">
            ...
            <div className="mb-2">
              ...
              <p className="text-gray-400 text-xs mt-1">This Week <span className="text-cyan-500 font-semibold">6.4% ▲</span></p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-gray-600 text-sm font-semibold">Job Applied</h3>
            ...
            <div className="mb-2">
              ...
              <p className="text-gray-400 text-xs mt-1">This Week <span className="text-red-500 font-semibold">0.5% ▼</span></p>
            </div>
          </div>
        </div>
      </div>
