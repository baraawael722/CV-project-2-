        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            <div className={`inline-flex flex-col items-center gap-4 px-8 py-6 rounded-2xl ${
              ...
              <svg className={`w-16 h-16 ${isDark ? "text-slate-600" : "text-gray-400"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              {(job.salaryMin || job.salaryMax) && (
                <p className={`text-lg font-semibold mb-6 ${
                  ...
                  {job.currency || "$"}{job.salaryMin?.toLocaleString() || "0"} - {job.currency || "$"}{job.salaryMax?.toLocaleString() || "N/A"}
                </p>
              )}
            ...
            <div className="flex items-start gap-4 mb-6">
              <div className={`w-20 h-20 rounded-2xl flex items-center justify-center ${
                ...
                {selectedJob.companyLogo ? (
                  ...
                  <svg className={`w-10 h-10 ${isDark ? "text-blue-400" : "text-blue-600"}`} fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 7V3H2v18h20V7H12zM6 19H4v-2h2v2zm0-4H4v-2h2v2zm0-4H4V9h2v2zm0-4H4V5h2v2zm4 12H8v-2h2v2zm0-4H8v-2h2v2zm0-4H8V9h2v2zm0-4H8V5h2v2zm10 12h-8v-2h2v-2h-2v-2h2v-2h-2V9h8v10zm-2-8h-2v2h2v-2zm0 4h-2v2h2v-2z"/>
                  </svg>
                )}
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              {selectedJob.location && (
                <div className={`flex items-center gap-2 p-3 rounded-xl ${
                  ...
                  <span className={isDark ? "text-slate-300" : "text-slate-700"}>{selectedJob.location}</span>
                </div>
              )}
              {selectedJob.jobType && (
                <div className={`flex items-center gap-2 p-3 rounded-xl ${
                  ...
                  <span className={isDark ? "text-slate-300" : "text-slate-700"}>{selectedJob.jobType}</span>
                </div>
              )}
              {selectedJob.department && (
                <div className={`flex items-center gap-2 p-3 rounded-xl ${
                  ...
                  <span className={isDark ? "text-slate-300" : "text-slate-700"}>{selectedJob.department}</span>
                </div>
              )}
              {selectedJob.experienceLevel && (
                <div className={`flex items-center gap-2 p-3 rounded-xl ${
                  ...
                  <span className={isDark ? "text-slate-300" : "text-slate-700"}>{selectedJob.experienceLevel}</span>
                </div>
              )}
            </div>
            ...
            {(selectedJob.salaryMin || selectedJob.salaryMax) && (
              <div className={`p-4 rounded-xl mb-6 ${
                ...
                <p className={`text-xl font-bold ${
                  ...
                  Salary: {selectedJob.currency || "$"}{selectedJob.salaryMin?.toLocaleString() || "0"} - {selectedJob.currency || "$"}{selectedJob.salaryMax?.toLocaleString() || "N/A"}
                </p>
              </div>
            )}
