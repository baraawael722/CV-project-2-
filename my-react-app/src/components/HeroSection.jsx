  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div
          className="absolute top-20 left-10 w-72 h-72 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float"
          style={{ animationDelay: "0s" }}
        ></div>
        <div
          className="absolute top-40 right-10 w-96 h-96 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute -bottom-32 left-1/3 w-96 h-96 bg-pink-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative reveal" data-delay="2">
          <div className="relative w-full h-[600px] flex items-center justify-center">
            ...
            {/* Floating Elements */}
            <div
              className="absolute top-10 right-10 bg-white rounded-2xl shadow-2xl p-4 animate-float"
            ...
            <div
              className="absolute bottom-20 left-10 bg-white rounded-2xl shadow-2xl p-4 animate-float"
            ...
            <div
              className="absolute top-1/3 left-5 bg-white rounded-2xl shadow-2xl p-3 animate-float"
